...
static const char *light_up[] = {"/usr/bin/xbacklight", "-inc", "20", NULL};
static const char *light_down[] = {"/usr/bin/xbacklight", "-dec", "20", NULL};
static const int new_window_attach_on_end = 0; /*  1 means the new window will attach on the end; 0 means the new window will attach on the front,default is front */
#define ICONSIZE 19   /* icon size */
#define ICONSPACING 8 /* space between icon and title */


static const char *fonts[]          = {"Courier:style:medium:size=11" ,"JetBrainsMono Nerd Font Mono:style:medium:size=19" };
static char dmenufont[]             = "Courier:size=12";
...
static const char *colors[][3]      = {
    ...
    [SchemeTag3]       = { purple,    black,  black },
    [SchemeTag4]       = { yellow,   black,  black },
    [SchemeTag5]       = { glacier,    black,  black },
...
static const Rule rules[] = {
    ...
    { "obsidian",  "obsidian",NULL,       1<<2,         0,           0,           -1 },
...
/* commands */
static const char *menu[] = { "dmenu_run", "-fn", dmenufont, "-nb", "#282828"};
...
//    { MODKEY|ShiftMask,                 XK_Return,  zoom,           {0} },
    ...
    // kill dwm
    { MODKEY|ShiftMask,               XK_q,       spawn,        SHCMD("pkill -u $(whoami)") },
